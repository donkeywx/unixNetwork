#ifndef __DONKEY_HTTP_PARSE_H__
#define __DONKEY_HTTP_PARSE_H__
...
public:
     ...
     */
    HttpRequest::Ptr getHttpRequest() const { return m_httpRequest;}
...
public:
     ...
     */
    HttpResponse::Ptr getHttpReponse() const { return m_httpReponse;}
...
private:
    ...
    /// HttpResponse
    HttpResponse::Ptr m_httpReponse;
    /// 错误码
    /// 1001: invalid version
    /// 1002: invalid field
    int m_error;
